...
public class Beaches extends Recreation{
    ...
    public static Comparator<Beaches> COMPARE_BY_DISTANCE = new Comparator<Beaches>() {
        public int compare(Beaches one, Beaches other) {
